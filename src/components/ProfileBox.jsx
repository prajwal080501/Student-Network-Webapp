...
const ProfileBox = () => {
    return (
        <div className="sticky top-10 flex flex-col items-center overflow-y-scroll justify-center w-full lg:w-fit lg:h-fit mb-5 mx-3 shadow-md mt-8 bg-black/80 p-5 rounded-lg">
            <div className="flex flex-col space-y-5 items-center  justify-center w-full h-[30%]">
                <div className="flex items-center justify-center">
                    <img src="https://images.unsplash.com/photo-1516802273409-68526ee1bdd6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" className="w-32 h-32 rounded-full shadow-md cursor-pointer border-4 border-blue-600 drop-shadow-xl" alt="profile" />
                </div>
